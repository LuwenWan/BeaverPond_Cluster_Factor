...
library(ggplot2)
library(dplyr)
library(ggspatial)  # Load the ggspatial library for scale bar and north arrow
library(grid)
library(cowplot)
library(units)
library(purrr)
...
ggsave(paste0(outfig,"/study_area_map_color2_update1.pdf"), plot = last_plot(), width = 6.5, height = 6, units = "in", dpi = 600)
```
